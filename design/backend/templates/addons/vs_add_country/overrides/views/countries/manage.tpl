...
{capture name="adv_buttons"}
    {include file="common/tools.tpl" tool_href="vs_add_country.update" prefix="top" hide_tools="true" title=__("add_country") icon="icon-plus"}
{/capture}

{/capture}
{include file="common/mainbox.tpl" title=__("countries") content=$smarty.capture.mainbox buttons=$smarty.capture.buttons adv_buttons=$smarty.capture.adv_buttons select_languages=true}
